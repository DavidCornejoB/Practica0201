...
public class VentanaEliminar extends JInternalFrame{
    ...
    public VentanaEliminar(String title) {
    ...
    public void initComponents() {
        ...
        this.checkList.add(new JCheckBox("Eliminar aqui"));

        this.buttonList.add(new JButton("Eliminar"));

        for (int i = 0; i < this.buttonList.size(); i++) {
            this.buttonList.get(i).addActionListener(new Eliminar(this));
        }

        this.checkList.get(0).addActionListener(new Eliminar(this));
        this.comboBox.addActionListener(new Eliminar(this));
        this.comboBox1.addActionListener(new Eliminar(this));
        this.comboBox2.addActionListener(new Eliminar(this));

        JPanel panelPrincipal = new JPanel(new BorderLayout());
        JPanel panelNorte = new JPanel(new GridLayout(3, 3));
