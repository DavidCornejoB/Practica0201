...
public class VentanaCrearCarpeta extends JInternalFrame {
    ...
    public VentanaCrearCarpeta(String title) {
    ...
    public void initComponents() {
        ...
        for (int i = 0; i < this.buttonList.size(); i++) {
            this.buttonList.get(i).addActionListener(new CrearCarpeta(this));
        }

        this.comboBox.addActionListener(new CrearCarpeta(this));
        this.comboBox1.addActionListener(new CrearCarpeta(this));       
